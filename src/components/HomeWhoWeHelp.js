...
const HomeFoundations = () => {
    const [foundations] = useState([
        ...
        {
            title: "Fundacja “Bez rodziców”",
            description:
                "Cel i misja: Pomoc dla osób nie posiadających miejsca zamieszkania.",
            items: "ubrania, jedzenie, ciepłe koce",
        },
        {
            title: "Fundacja “Motylek”",
            description:
                "Cel i Misja: Pomoc osobom znajdującym się w trudnej sytuacji życiowej.",
            items: "ubrania, jedzenie, sprzęt AGD, meble, zabawki",
        },
        {
            title: "Fundacja “Tęcza”",
            description: "Cel i misja: Pomoc dzieciom z ubogich rodzin.",
            items: "ubrania, meble, zabawki",
        },
        {
            title: "Fundacja “Serduszko”",
            description:
                "Cel i misja: Pomoc dla osób nie posiadających miejsca zamieszkania.",
            items: "ubrania, jedzenie, ciepłe koce",
        },
    ...
    return (
        <div className="foundations" id="foundations">
            ...
            <div
                className={
                    activeButtonIndex === 0
                        ? "foundations__found active"
                        : "foundations__found"
                }
            >
                <p className="foundations__descr">
